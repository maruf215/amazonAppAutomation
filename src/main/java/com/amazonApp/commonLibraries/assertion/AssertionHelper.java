package com.amazonApp.commonLibraries.assertion;
...
public class AssertionHelper {
	...
	public static void verifyPartialText(String s1, String s2){
		log.info("Expected text: "+ s1);
		log.info("Actual text: "+ s2);
		if(s2.contains(s1)) {
			log.info("Text is displayed as expected");
		}
		else {
			log.info("Text is not displayed as expected");
		}
